    ...
    pub const schemas = struct {
        ...
        pub const client_dll = struct {
            ...
            pub const tR = struct {
                ...
                pub const @"": usize = 0x0; // 
                pub const @"": usize = 0x0; // 
                pub const @"": usize = 0x80010C80; // 
                pub const @"": usize = 0x80010080; // 
                pub const @"": usize = 0x0; // 
                pub const @"": usize = 0x80020000; // 
                pub const @"": usize = 0x80030100; // 
                pub const @"": usize = 0x800300C0; // 
                pub const @"": usize = 0x800400E0; // 
                pub const @"": usize = 0x80040070; // 
            };
            // Parent: None
            // Field count: 12
            pub const tR = struct {
