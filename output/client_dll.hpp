    ...
    namespace schemas {
        ...
        namespace client_dll {
            ...
            namespace tR {
                ...
                constexpr std::ptrdiff_t  = 0x0; // 
                constexpr std::ptrdiff_t  = 0x0; // 
                constexpr std::ptrdiff_t  = 0x80010C80; // 
                constexpr std::ptrdiff_t  = 0x80010080; // 
                constexpr std::ptrdiff_t  = 0x0; // 
                constexpr std::ptrdiff_t  = 0x80020000; // 
                constexpr std::ptrdiff_t  = 0x80030100; // 
                constexpr std::ptrdiff_t  = 0x800300C0; // 
                constexpr std::ptrdiff_t  = 0x800400E0; // 
                constexpr std::ptrdiff_t  = 0x80040070; // 
            }
            // Parent: None
            // Field count: 12
            namespace tR {
